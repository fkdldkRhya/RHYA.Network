...
try {
	...
	final String path = PathManager.UTAITE_PLAYER_IMAGE_ROOT_PATH;
	...
	// 로그 출력
	rl.Log(RhyaLogger.Type.Info, rl.CreateLogTextv5(clientIP, "우타이테 플레이어 이미지 출력 성공! - ".concat(getFile.getName())));
}catch (Exception ex) {
	// 로그 출력
